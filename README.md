...
[Documentação - Firebase Cloud Messaging](https://firebase.google.com/docs/cloud-messaging/server)
...
export function usePushNotification(): UsePushNotificationProps {...}
```
